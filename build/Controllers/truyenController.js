...
const CreateTruyenController = async (req, res) => {
  ...
  const newTruyen = await CreateTruyenService({
    truyen_ma,
    truyen_ten,
...
const GetTruyenController = async (req, res) => {
  ...
  const truyen = await GetTruyenService({
    truyen_ma
  });
  if (truyen.error) {
...
const GetAllTheLoaiController = async (req, res) => {
  ...
  const search = req.query.search || '';
  const theloaiList = await GetAllTheLoaiService({
    limit,
    page,
    search
  });
...
const CreateTheLoaiController = async (req, res) => {
  ...
  const newTheLoai = await CreateTheLoaiService({
    ten_theloai
  });
  if (newTheLoai.error) {
...
const UpdateTheloaiController = async (req, res) => {
  ...
  const result = await UpdateTheLoaiService({
    id,
    ten_theloai
  });
  if (result.error) {
...
const AddTheLoaiInTruyenController = async (req, res) => {
  ...
  const newTheLoai = await AddTheLoaiInTruyenService({
    TruyenId,
    TheLoaiIds
  });
  if (newTheLoai.error) {
...
const DeleteTheLoaiForTruyenController = async (req, res) => {
  ...
  const result = await DeleteTheLoaiForTruyenService({
    TruyenId,
    TheLoaiId
  });
  if (result.error) {
...
const CreateChuongController = async (req, res) => {
  ...
  const newChuong = await CreateChuongService({
    Chuong_so,
    Chuong_ten,
    Chuong_noidung,
    TruyenId
...
const AddImagesChuongController = async (req, res) => {
  ...
  if (req.files && req.files.length > 0) {
    ...
    const newImages = await AddImagesChuongService({
      ChuongId,
      images
    });
    if (newImages.error) {
...
const GetChuongController = async (req, res) => {
  ...
  const chuong = await GetChuongService({
    id,
    ChuongId
  });
  if (chuong.error) {
...
const UpdateTruyenController = async (req, res) => {
  ...
  const newTruyen = await UpdateTruyenService({
    truyen_ma,
    truyen_ten,
    truyen_hinhanhdaidien,
    truyen_tacgia,
...
const DeleteChuongController = async (req, res) => {
  ...
  const result = await DeleteChuongService({
    ChuongId
  });
  if (result.error) {
    return res.status(400).json(result);
...
const DeleteImagesChuongController = async (req, res) => {
  ...
  const result = await DeleteImagesChuongService({
    imagePath
  });
  if (result.error) {
    return res.status(400).json(result);
...
const UpdateSortImageController = async (req, res) => {
  ...
  console.log(images);
  const result = await UpdateSortImageService({
    id,
    images
  });
  if (result.error) {
...
const UpdateInfoChuongController = async (req, res) => {
  ...
  const result = await UpdateInfoChuongService({
    id,
    Chuong_so,
    Chuong_ten,
    Chuong_noidung,
