...
const GetAllTruyenHomeService = async ({
  page,
  limit,
  search,
  quoc_gia,
  ...
  try {
    ...
    const {
      ...
      attributes: ['id', 'truyen_ma', 'truyen_ten', 'truyen_hinhanhdaidien', 'truyen_tacgia', 'truyen_motangan', 'truyen_duyet', 'createdAt', 'truyen_luotxem', 'quoc_gia', 'isOver'],
      where: {
        truyen_duyet: 1,
        [Op.and]: [search ? {
          [Op.or]: [{
...
const GetChuongHomeService = async ({
  truyenid,
  chuongid
}) => {
  try {
...
const AddFollowTruyenService = async ({
  truyen_id,
  user_id
}) => {
  try {
...
const GetAllFollowTruyenService = async ({
  user_id
}) => {
  try {
    const FollowTruyen = await db.TruyenYeuThich.findAll({
      ...
      include: [{
        model: db.Truyen,
        attributes: ['id', 'truyen_ma', 'truyen_ten', 'truyen_hinhanhdaidien', 'createdAt'],
        include: [{
          model: db.Chuong,
          attributes: ['id']
        }]
...
const DeleteFollowTruyenService = async ({
  truyen_id,
  user_id
}) => {
  try {
...
const AddLichSuTruyenService = async ({
  truyen_id,
  user_id
}) => {
  try {
...
const DeleteLichSuTruyenService = async ({
  truyen_id,
  user_id
}) => {
  try {
...
const GetAllLichSuTruyenService = async ({
  user_id
}) => {
  try {
...
const UpdateLuotXemService = async ({
  truyen_id
}) => {
  try {
...
const CreateRepCommentService = async ({
  user_id,
  comment_id,
  content
}) => {
...
const GetAllCommentOfUserService = async ({
  user_id
}) => {
  try {
...
const UpdateStatusCommentOfUserService = async ({
  comment_id,
  IsRead,
  IsShow
}) => {
...
const DeleteRepCommentService = async ({
  repcomment_id
}) => {
  try {
...
const UpdateRepCommentService = async ({
  repcomment_id,
  content
}) => {
  try {
